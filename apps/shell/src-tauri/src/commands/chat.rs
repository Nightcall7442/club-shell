...
use clubshell_protocol::commands::{
    names, ChatHistoryRequest, ChatHistoryResponse, ChatMarkReadRequest, ChatMarkReadResponse,
    ChatSendRequest,
};
...
pub async fn chat_history(
    ...
    q: Option<ChatHistoryRequest>,
) -> CmdResult<ChatHistoryResponse> {
...
pub async fn chat_mark_read(
    ...
    room_id: Option<String>,
) -> CmdResult<ChatMarkReadResponse> {
