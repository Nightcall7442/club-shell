...
const GAME_SEEDS: GameSeed[] = [
  ...
  },
  {
    ...
    seed: 'valorant',
    title: 'VALORANT',
    video: '/mock-art/valorant-hero.mp4',
    launcher: 'riot',
    appId: 'valorant',
    category: ['shooter', 'multiplayer'],
  ...
  },
  {
    ...
    seed: 'fortnite',
    title: 'Fortnite',
    video: '/mock-art/fortnite-hero.mp4',
    launcher: 'epic',
    appId: 'fn',
...
export const APPS: App[] = [
  {
    ...
    iconUrl: '/mock-art/app-chrome.svg',
    category: 'browser',
    allowed: true,
  },
  {
    ...
    iconUrl: '/mock-art/app-discord.svg',
    category: 'voice',
    allowed: true,
  },
  {
  ...
  },
  {
    ...
    iconUrl: '/mock-art/app-spotify.svg',
    category: 'media',
    allowed: true,
  },
  {
...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    category: 'drink',
    price: uzs(18_000),
    imageUrl: '/mock-art/p-redbull.jpg',
    inStock: true,
    stockQty: 22,
    tags: ['energy'],
  },
  {
    ...
    category: 'drink',
    price: uzs(15_000),
    imageUrl: '/mock-art/p-coffee.jpg',
    inStock: true,
    stockQty: null,
    tags: ['hot', 'coffee'],
  },
  ...
  },
  {
    ...
    category: 'food',
    price: uzs(38_000),
    imageUrl: '/mock-art/p-burger.jpg',
    inStock: true,
    stockQty: 8,
    tags: ['hot'],
  },
  {
    ...
    category: 'food',
    price: uzs(42_000),
    imageUrl: '/mock-art/p-lavash.jpg',
    inStock: false,
    stockQty: 0,
    tags: ['hot'],
  },
  ...
  },
  {
    ...
    category: 'snack',
    price: uzs(8_000),
    imageUrl: '/mock-art/p-snickers.jpg',
    inStock: true,
    stockQty: 50,
    tags: ['sweet'],
  },
  {
    ...
    category: 'service',
    price: uzs(10_000),
    imageUrl: '/mock-art/p-headset.jpg',
    inStock: true,
    stockQty: null,
    tags: ['rental'],
  },
  {
    ...
    category: 'service',
    price: uzs(15_000),
    imageUrl: '/mock-art/p-gamepad.jpg',
    inStock: true,
    stockQty: 4,
    tags: ['rental'],
  },
  {
    ...
    category: 'merch',
    price: uzs(120_000),
    imageUrl: '/mock-art/p-tshirt.jpg',
    inStock: true,
    stockQty: 12,
    tags: ['merch', 'black'],
  },
  {
    ...
    category: 'time',
    price: uzs(12_000),
    imageUrl: '/mock-art/p-time60.svg',
    inStock: true,
    stockQty: null,
    tags: ['time'],
  },
  {
    ...
    category: 'time',
    price: uzs(33_000),
    imageUrl: '/mock-art/p-time180.svg',
    inStock: true,
    stockQty: null,
    tags: ['time', 'deal'],
  },
...
export const LEADERBOARD: LeaderboardEntry[] = [
  { rank: 1, userId: P(1), name: 'Sardor K.', score: 48, avatarUrl: null },
  { rank: 2, userId: P(2), name: 'Jasur T.', score: 41, avatarUrl: null },
  { rank: 3, userId: USER_ID, name: 'Bobur Y.', score: 39, avatarUrl: null },
  { rank: 4, userId: P(5), name: 'Diyor M.', score: 33, avatarUrl: null },
  { rank: 5, userId: P(4), name: 'Umid R.', score: 27, avatarUrl: null },
  { rank: 6, userId: P(6), name: 'Azamat S.', score: 21, avatarUrl: null },
...
export const ACHIEVEMENTS: Achievement[] = [
  {
    ...
    iconUrl: '/mock-art/ach-first.svg',
  ...
  },
  {
    ...
    iconUrl: '/mock-art/ach-marathon.svg',
  ...
  },
  {
    ...
    iconUrl: '/mock-art/ach-regular.svg',
    unlockedAt: null,
  ...
  },
  {
    ...
    iconUrl: '/mock-art/ach-champion.svg',
    unlockedAt: null,
  ...
  },
  {
    ...
    iconUrl: '/mock-art/ach-spender.svg',
    unlockedAt: null,
