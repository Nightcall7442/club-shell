...
- **Фирменные моменты.** После входа HUD «включается»: полосы выезжают, скобки разлетаются из центра по углам.
  Запуск игры — полноэкранная последовательность поверх арта: наезд камеры, телеметрия шагов, шкала-засечки с
  точечным процентом, вспышка «готово». Экран простоя — постер с огромными точечными часами и мигающей кареткой.
  Панель в игре (`Ctrl+Shift+H`) в той же рамке. Пустые состояния — «пустая цель» в скобках, а не просто иконка.
