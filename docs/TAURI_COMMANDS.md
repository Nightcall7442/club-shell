...
| `profile_game_settings` | `api.profile.gameSettings(): Promise<PlayerSettingsItem[]>` | `{}` | `PlayerSettingsItem[]` | `profile.gameSettings` |
| `profile_game_settings_reset` | `api.profile.resetGameSettings(gameId: string): Promise<PlayerSettingsItem[]>` | `{ gameId: string }` | `PlayerSettingsItem[]` | `profile.gameSettingsReset` |
